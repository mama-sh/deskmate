...
description: "Structured logging, distributed tracing, and metrics for production applications. Use when setting up production logging, adding observability to a service, debugging distributed systems, designing alerting, or implementing traces/metrics/logs. Covers OpenTelemetry, correlation IDs, SLI/SLO alerting thresholds, and dashboards."
---
